...
# Konfigurasi halaman
st.set_page_config(page_title="Heart Aware", layout="wide")
st.title("Heart Aware: Heart Disease Prediction App")

# Header deskripsi
st.markdown("""
Heart aware app dibuat dengan harapan dapat membantu Anda dalam memprediksi **Penyakit Jantung**. Dibuat oleh [@angelinert](https://www.linkedin.com/in/angeline-riendra-tatipang-3a868528b/)
